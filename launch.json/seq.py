...
print("Элемент 0 -", shoplist[0]) # вывожу список, -1 это обратный отсчёт
...
print("Элементы с 1 по 3:", shoplist[::1])
print("Элементы с 2 до конца:", shoplist[::2])
print("Элементы с 1 по -1:", shoplist[::3])
print("Элементы от начала до конца:", shoplist[::-1])
